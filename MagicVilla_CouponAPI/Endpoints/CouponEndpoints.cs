...
{
	/// <summary>
	/// This class holds CRUD operations for Coupon Endpoint
	/// </summary>
    ...
    /// <summary>
    /// Returns all the Coupons in the database.
    /// </summary>
    /// <param name="_logger"></param>
    /// <param name="_couponRepo"></param>
    ...
    /// </summary>
    /// <param name="couponRequest">Fill the JSON below to update an existing Coupon</param>
    ...
    /// </summary>
    /// <param name="id">Coupon Id to Delete</param>
    /// <returns>The HTTP Status Code</returns>
